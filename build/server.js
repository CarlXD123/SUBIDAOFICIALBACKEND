...
const rMatchDataDetail_1 = __importDefault(require("./routes/rApilisMatchDataDetail"));
const rMonitor_1 = __importDefault(require("./routes/rApilisMonitor"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use("/api/matchdetail", rMatchDataDetail_1.default);
        this.app.use("/api/monitor", rMonitor_1.default);
